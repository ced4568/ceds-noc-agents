...
Built by Chase Dumphord (Ced) DevOps and Cloud Infrastructure Engineer
...
```
Biggie Proxmox Node
└── VM 300: ai-agent-lab (<ai-agent-vm-ip>)
    ├── Ubuntu 24.04
    ├── Python 3.12
    ├── CrewAI 1.14.4
    └── NOC Analyst Crew
...
└── VM 400: ai-inference (<ai-inference-vm-ip>)
    ├── Ubuntu 24.04
...
```python
base_url="http://<ai-inference-vm-ip>:11434"
```
...
| Project | Description |
|---------|-------------|
| [ceds-observability-stack](https://github.com/ced4568/ceds-observability-stack) | Prometheus, Grafana, Node Exporter, Blackbox Exporter, Uptime Kuma |
...
This lab directly supports my work as a DevOps and Cloud Infrastructure Engineer and serves as a portfolio of real infrastructure engineering skills.
